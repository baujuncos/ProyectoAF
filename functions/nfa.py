...
class NFA:
    ...
    def OrNode(self, node):
        ...
        # desde el inicial al primer epsilon
        self.dot.edge(
            str(initial_node),
            str(self.curr_state),
            'e'
        ...
        # desde el inicial al segundo epsilon
        self.dot.edge(
            str(initial_node),
            str(self.curr_state),
            'e'
        ...
        # desde el primero al ultimo epsilon
        self.dot.edge(
            str(mid_node),
            str(self.curr_state),
            'e'
        ...
        # desde el segundo al ultimo epsilon
        self.dot.edge(
            str(self.curr_state - 1),
            str(self.curr_state),
            'e'
    ...
    def KleeneNode(self, node):
        ...
        # nodo en el último estado al primer epsilon
        self.dot.edge(
            str(self.curr_state),
            str(first_node + 1),
            'e'
        ...
        # Del primer epsilon al ultimo estado
        self.dot.edge(
            str(first_node),
            str(self.curr_state),
            'e'
    ...
    def QuestionNode(self, node):
        ...
        # desde el primero al primer epsilon
        self.dot.edge(
            str(initial_node),
            str(self.curr_state),
            'e'
        ...
        # desde el primero al segundo epsilon
        self.dot.edge(
            str(initial_node),
            str(self.curr_state),
            'e'
